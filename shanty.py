# Program name: shanty.py
# Your Name: Aerin Schmall
# Python Version: 3.7.8
# Date Started - Date Finished: 9/7/2020 - 9/7/2020
# Description: prints all 100 lines of the bottles of beer song
...
def beer(a):
      ...
      if a == 1:
            ...
            print(f'{a} bottle of beer on the wall, {a} bottles of beer.')
            print('Take one down, pass it around, no more bottle of beer on the wall.\n')
            print('No more bottles of beer on the wall, no more bottles of beer.')
            print('Go to the store and buy some more, 99 bottles of beer on the wall.')
            return
      else:
            print(f'{a} bottles of beer on the wall, {a} bottles of beer.')
            print('Take one down, pass it around,', end=' ')
      beer(a-1)
beer(99)

'''
============= RESTART: C:\\Users\\aerin\\Documents\\Python\\shanty.py ==============
